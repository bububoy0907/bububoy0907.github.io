...
export const PROJECTS = [
  {
    ...
    gallery: [
      { type: "image", src: "./assets/gallery/webar/01.webp", tag: "UI",   caption: "Main Interface" },
      { type: "image", src: "./assets/gallery/webar/02.webp", tag: "AR",   caption: "Main Interface" },
      { type: "image", src: "./assets/gallery/webar/03.webp", tag: "AR",   caption: "webGL disabled view" },
      { type: "image", src: "./assets/gallery/webar/04.webp", tag: "UI",   caption: "Figa Design" },
      { type: "image", src: "./assets/gallery/webar/05.webp", tag: "AR",   caption: "8th-Wall Development" },
      { type: "image", src: "./assets/gallery/webar/06.webp", tag: "AR",   caption: "3d Model Implementation" },
      { type: "image", src: "./assets/gallery/webar/07.webp", tag: "UI",   caption: "3d Model Implementation" },
      { type: "image", src: "./assets/gallery/webar/08.webp", tag: "AR",   caption: "Campus 3D Model Design" },
      { type: "image", src: "./assets/gallery/webar/09.webp", tag: "AR",   caption: "Full Campus View" },
    ],
  },

  {
    ...
    screenshot: "./assets/screenshots/unity-driving.png",
        gallery: [
      { type: "image", src: "./assets/gallery/unity/01.webp", tag: "Route", caption: "AI Vehicle Behaviour Debug" },
      { type: "image", src: "./assets/gallery/unity/02.webp", tag: "Logic", caption: "Capstone Project Title Screen" },
      { type: "image", src: "./assets/gallery/unity/03.webp", tag: "Route", caption: "Capstone Project Result Report" },
      { type: "image", src: "./assets/gallery/unity/04.webp", tag: "Logic", caption: "NPC Vehicle Waypoint Design" },      
      { type: "image", src: "./assets/gallery/unity/05.webp", tag: "Route", caption: "NPC Vehicle Waypoint Design" },
      { type: "image", src: "./assets/gallery/unity/06.webp", tag: "Logic", caption: "Map Comparison with the actual Google Street View" },
      { type: "image", src: "./assets/gallery/unity/07.webp", tag: "Route", caption: "Map Comparison with the actual Google Street View" },
      { type: "image", src: "./assets/gallery/unity/08.webp", tag: "Logic", caption: "Map Comparison with the actual Google Street View" },  
      { type: "image", src: "./assets/gallery/unity/09.webp", tag: "Route", caption: "Map Comparison with the actual Google Street View" },
      { type: "image", src: "./assets/gallery/unity/10.webp", tag: "Logic", caption: "Map Comparison with the actual Google Street View" },
      { type: "image", src: "./assets/gallery/unity/11.webp", tag: "Route", caption: "Map Comparison with the actual Google Street View" },
      { type: "image", src: "./assets/gallery/unity/12.webp", tag: "Logic", caption: "Map Comparison with the actual Google Street View" },  
      { type: "image", src: "./assets/gallery/unity/13.webp", tag: "Route", caption: "Map Comparison with the actual Google Street View" },
      { type: "image", src: "./assets/gallery/unity/14.webp", tag: "Logic", caption: "Map Comparison with the actual Google Street View" },
      { type: "image", src: "./assets/gallery/unity/15.webp", tag: "Route", caption: "Vehicle POV" },
      { type: "image", src: "./assets/gallery/unity/16.webp", tag: "Logic", caption: "Traffic Intersection Design" },  
      { type: "image", src: "./assets/gallery/unity/17.webp", tag: "Route", caption: "NPV Vehicle collider design" },
      { type: "image", src: "./assets/gallery/unity/18.webp", tag: "Logic", caption: "AI Vehicle Behaviour Log" },
      { type: "image", src: "./assets/gallery/unity/19.webp", tag: "Route", caption: "Map Design in Blender" },
      { type: "image", src: "./assets/gallery/unity/20.webp", tag: "Logic", caption: "Traffic-rule Alert UI" },  
    ],
  },
...

  {
    ...
    screenshot: "./assets/screenshots/wishcraft.png",
        gallery: [
      { type: "image", src: "./assets/gallery/wishcraft/01.webp", tag: "Ops",   caption: "Server Banner" },
      { type: "image", src: "./assets/gallery/wishcraft/02.webp", tag: "Community", caption: "Hero Class Skills Design" },
      { type: "image", src: "./assets/gallery/wishcraft/03.webp", tag: "Ops",   caption: "Character Skill Design" },
      { type: "image", src: "./assets/gallery/wishcraft/04.webp", tag: "Community", caption: "Boss Map" },
      { type: "image", src: "./assets/gallery/wishcraft/05.webp", tag: "Ops",   caption: "Lobby Map" },
      { type: "image", src: "./assets/gallery/wishcraft/06.webp", tag: "Community", caption: "RPG Item Design" },
      { type: "image", src: "./assets/gallery/wishcraft/07.webp", tag: "Ops",   caption: "Quest Design" },
      { type: "image", src: "./assets/gallery/wishcraft/08.webp", tag: "Community", caption: "GamePlay POV" },
      { type: "image", src: "./assets/gallery/wishcraft/09.webp", tag: "Ops",   caption: "User Interface" },
      { type: "image", src: "./assets/gallery/wishcraft/10.webp", tag: "Community", caption: "Combat Skills Design" },
      { type: "image", src: "./assets/gallery/wishcraft/11.webp", tag: "Ops",   caption: "Game Map" },
      { type: "image", src: "./assets/gallery/wishcraft/12.webp", tag: "Community", caption: "Game Map Design Progress" },
      { type: "image", src: "./assets/gallery/wishcraft/13.webp", tag: "Ops",   caption: "Game Map High-Level View" },
      { type: "image", src: "./assets/gallery/wishcraft/14.webp", tag: "Community", caption: "Custom Design Weapon Texture" },
      { type: "image", src: "./assets/gallery/wishcraft/15.webp", tag: "Ops",   caption: "Weapon Design Showcase" },
      { type: "image", src: "./assets/gallery/wishcraft/16.webp", tag: "Community", caption: "Skills Icon Design Showcase" },
      { type: "image", src: "./assets/gallery/wishcraft/17.webp", tag: "Ops",   caption: "Monster/Boss Design Showcase" },
      { type: "image", src: "./assets/gallery/wishcraft/18.webp", tag: "Community", caption: "Game Interface Showcase" },
    ],
  },

  {
    ...
    gallery: [
      { type: "image", src: "./assets/gallery/petmatch/01.webp", tag: "UI",  caption: "Main Interface" },
    ],
  }
];
